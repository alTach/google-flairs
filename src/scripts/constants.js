export const UI = {
  en: {
    ...
    lead:
      "Each card is tied to a real flair code from src/data. By default it shows SVG, the img button switches the asset, the image opens in a centered dialog, and the count reveals all association words.",
